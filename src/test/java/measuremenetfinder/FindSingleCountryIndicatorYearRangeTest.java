...
public class FindSingleCountryIndicatorYearRangeTest {
    ...
    private FindSingleCountryIndicatorYearRangeImpl findSingleCountryIndicator;
    ...
    public void setUp() throws Exception {
        ...
        findSingleCountryIndicator = new FindSingleCountryIndicatorYearRangeImpl(
                meas);
        // create a test model
    ...
    public void testFindSingleCountryIndicatorYearRange() {
        SingleMeasureRequestModel request = findSingleCountryIndicator
                .findSingleCountryIndicatorYearRange("GrenadaTest", "Grenada", "Storm", 1980, 2000);
    ...
    @Test
    public void testFailingYearRangeIndicator() {
        assertThrows(
                IllegalArgumentException.class,
                () -> findSingleCountryIndicator
                        .findSingleCountryIndicatorYearRange("GrenadaTest", "Grenada", "Kareklopodara", 1980, 2000));
    }
}
